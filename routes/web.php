...
Route::get("activateuser/{NidUser}",[UserController::class,"ActivateUser"])->name('user.ActivateUser');
Route::get("deleteuser/{NidUser}",[UserController::class,"DeleteUser"])->name('user.DeleteUser');
Route::get("reactivateuser/{NidUser}",[UserController::class,"ReactivateUser"])->name('user.ReactivateUser');
