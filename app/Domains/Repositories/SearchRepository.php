                ...
                case 1:
                    switch ($ById) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and NationalCode LIKE '%" . $searchText . "%'");
                            break;
                        case 3:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and Mobile LIKE '%" . $searchText . "%'");
                            break;
                        case 4:
                        ...
                        case 5: //CollaborationType
                            ...
                            break;
                        case 6:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and t2.Title LIKE '%" . $searchText . "%'");
                            break;
                        case 7:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and t3.Title LIKE '%" . $searchText . "%'");
                            break;
                        case 8:
                ...
                case 1:
                    switch ($ById) {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and NationalCode = '" . $searchText . "'");
                            break;
                        case 3:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and Mobile = '" . $searchText . "'");
                            break;
                        case 4:
                        ...
                        case 5: //CollaborationType
                            ...
                            break;
                        case 6:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and t2.Title = '" . $searchText . "'");
                            break;
                        case 7:
                            return DB::select("select NidScholar,FirstName,LastName,NationalCode,t2.Title as MajorName,t3.Title as OreintationName from scholars t1 join majors t2 on t1.MajorId = t2.NidMajor join oreintations t3 on t1.OreintationId = t3.NidOreintation WHERE IsDeleted = false and t3.Title = '" . $searchText . "'");
                            break;
                        case 8:
