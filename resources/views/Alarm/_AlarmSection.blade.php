{{-- @model List<DataAccessLibrary.Models.Alarm> --}}
    ...
    @foreach ($alarms as $alm)
        @switch ($alm->AlarmSubject)
            @case ('PreImployment')
                <a class="dropdown-item d-flex align-items-center" href="{{URL::to('/alarms/1')}}">
                    <div class="mr-3">
            ...
            @case ('ThirtyLetter')
                ...
                @break
            @case ('SixtyLetter')
                <a class="dropdown-item d-flex align-items-center" href="{{URL::to('/alarms/4')}}">
                    <div class="mr-3">
                        <div class="icon-circle bg-gradient-warning">
                            <i class="fas fa-file-signature text-white"></i>
                        </div>
                ...
                @break
            @case ('ThesisLetter')
                <a class="dropdown-item d-flex align-items-center" href="{{URL::to('/alarms/5')}}">
                    <div class="mr-3">
                        <div class="icon-circle bg-gradient-warning">
                            <i class="fas fa-file-signature text-white"></i>
                        </div>
                ...
                @break
            @case ('RefInfo')
                <a class="dropdown-item d-flex align-items-center" href="{{URL::to('/alarms/6')}}">
                    <div class="mr-3">
                        <div class="icon-circle bg-gradient-warning">
                            <i class="fas fa-file-signature text-white"></i>
                        </div>
                ...
                @break
            @case ('EditorInfo')
                <a class="dropdown-item d-flex align-items-center" href="{{URL::to('/alarms/7')}}">
                    <div class="mr-3">
                        <div class="icon-circle bg-gradient-warning">
                            <i class="fas fa-file-signature text-white"></i>
                        </div>
                ...
                @break
            @case ('AdvSupInfo')
                <a class="dropdown-item d-flex align-items-center" href="{{URL::to('/alarms/8')}}">
                    <div class="mr-3">
                        <div class="icon-circle bg-gradient-warning">
                            <i class="fas fa-file-signature text-white"></i>
                        </div>
        ...
        @endswitch
    @endforeach
    <a class="dropdown-item text-center small text-gray-500" href="{{URL::to('/alarms/0')}}">نمایش تمامی اعلان ها</a>
