                                ...
                                <form class="user" enctype="application/x-www-form-urlencoded" id="AddReportForm">
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="ReportName"
                                                name="ReportName" placeholder="نام گزارش">
                                        </div>
                                        <div class="col-sm-6">
                                            <select class="form-control allWidth" data-ng-style="btn-primary"
                                                placeholder="موجودیت گزارش" id="sltContext" name="ContextId"
                                                style="padding:0 .75rem;">
                                                <option value="0" selected>موجودیت گزارش</option>
                                                <option data-tokens="محقق" value="1">محقق</option>
                                                <option data-tokens="طرح" value="2">طرح</option>
                                                <option data-tokens="کاربر" value="4">کاربر</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div id="Partials">
                                        <div class="form-group row">
                                            <div class="col-sm-6 mb-3 mb-sm-0">
                                                <select class="form-control allWidth" data-ng-style="btn-primary"
                                                    placeholder="جستجو بر اساس" id="sltField" name="FieldId"
                                                    onchange="FieldChange()" style="padding:0 .75rem;">
...
@section('scripts')
    <script type="text/javascript">
                ...
                if (!CheckInputValidity()) {
                    ...
                    $.ajax({
                        ...
                        data: {
                            ...
                            ContextId: $("#sltContext").val(),
                            FieldId: $("#sltField").val(),
        ...
        function CheckInputValidity() {
            ...
            if ($("#sltContext").val() == "0" || !$("#sltContext").val()) {
                ValiditiyMessage += '<li>';
                ValiditiyMessage += "موجودیت انتخاب نشده است";
                ValiditiyMessage += '</li>';
                isValid = false;
            }
            if ($("#sltField").val() == "0" || !$("#sltField").val()) {
                ValiditiyMessage += '<li>';
