            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <form class="user" id="EditRolePermissionForm" action="{{ route('user.SubmitEditRolePermission') }}" method="POST">
                            @csrf
                            <input type="text" id="NidPermission" name="NidPermission" value="{{ $Role->NidPermission }}" hidden>
                                ...
                                <div class="col-sm-6" style="display: flex;">
                                    ...
                                    <select class="form-control allWidth" data-ng-style="btn-primary" id="EntityId"
                                        ...
                                        @if($ent['EntityId'] == $Role->EntityId)
                                            <option value="{{ $ent['EntityId'] }}" selected>{{ $ent['Title'] }}</option>
                                        @else
                            ...
                            <div class="form-group row" style="margin-top: 3rem;">
                                ...
                                <div class="col-sm-1" style="display: flex;">
                                    @if ($Role->Edit)
                                    <input type="checkbox" style="width:1rem;margin:unset !important;" id="Edit" name="Edit"
