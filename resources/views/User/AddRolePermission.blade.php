            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="p-5">
                        ...
                        <form class="user" id="AddRolePermissionForm" action="{{ route('user.SubmitAddRolePermission') }}" method="POST">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6 mb-3 mb-sm-0">
                                    <select class="form-control allWidth" data-ng-style="btn-primary" id="RoleId"
                                        ...
                                        <option value="0" disabled selected>نقش</option>
                                        @foreach ($Roles->sortBy('Title') as $rls)
