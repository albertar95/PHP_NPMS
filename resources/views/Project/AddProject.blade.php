        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="p-5">
                    ...
                    <form class="user" id="AddProjectForm">
                        ...
                        <div class="form-group row">
                            <div class="col-sm-6 mb-3 mb-sm-0" style="display:flex;padding-right:10%;">
                                <input type="checkbox" style="width:1rem;margin:unset !important;margin-right:10%;" id="TitleApproved" name="TitleApproved" class="form-control" onclick="$(this).attr('value', this.checked ? 'true' : 'false')" />
                                <label for="TitleApproved" style="margin:.25rem .25rem 0 0">عنوان طرح تایید شده است؟</label>
                            </div>
                            <div class="col-sm-6">
                                <input type="text" class="form-control form-control-user" id="ATFLetterDate" name="ATFLetterDate"
                                       placeholder="تاریخ ارسال نامه به عتف">
                            </div>
                        </div>
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseExtraItems" class="d-block card-header py-3 collapsed" data-toggle="collapse"
                               role="button" aria-expanded="false" aria-controls="collapseExtraItems">
                            ...
                            <div class="collapse" id="collapseExtraItems">
                                <div class="card-body">
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="Supervisor" name="Supervisor"
                                                   placeholder="استاد راهنما">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="SupervisorMobile" name="SupervisorMobile"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="Advisor" name="Advisor"
                                                   placeholder="استاد مشاور">
                                            <p id="AdvisorMobileError" style="font-size:.75rem;text-align:center;color:tomato;" hidden></p>
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="AdvisorMobile" name="AdvisorMobile"
                                                   placeholder="شماره تماس استاد مشاور">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="Referee1" name="Referee1"
                                                   placeholder="داور اول">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="Referee2" name="Referee2"
                                                   placeholder="داور دوم">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="PreImploymentLetterDate" name="PreImploymentLetterDate"
                                                   placeholder="تاریخ رو گرفت">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="ImploymentDate" name="ImploymentDate"
                                                   placeholder="تاریخ بکارگیری">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="Editor" name="Editor"
                                                   placeholder="ویراستار">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="TenPercentLetterDate" name="TenPercentLetterDate"
                                                   placeholder="تاریخ نامه 10 درصد">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="ThirtyPercentLetterDate" name="ThirtyPercentLetterDate"
                                                   placeholder="تاریخ تحویل فرم 30 درصد">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="SixtyPercentLetterDate" name="SixtyPercentLetterDate"
                                                   placeholder="تاریخ تحویل فرم 60 درصد">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="SecurityLetterDate" name="SecurityLetterDate"
                                                   placeholder="تاریخ نامه حفاظت">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control form-control-user" id="ThesisDefenceDate" name="ThesisDefenceDate"
                                                   placeholder="تاریخ دفاعیه">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-sm-6 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="ThesisDefenceLetterDate" name="ThesisDefenceLetterDate"
                                                   placeholder="تاریخ ارسال نامه دفاعیه">
                                        </div>
                                        <div class="col-sm-6">
                                            <input type="number" class="form-control form-control-user" id="ReducePeriod" name="ReducePeriod"
                    ...
                    {
                        <a href="@Url.Action("Projects","Home")" class="btn btn-outline-secondary btn-user btn-block" style="width:25%;margin:auto;">
                            لیست طرح ها
                        </a>
                    } --}}
