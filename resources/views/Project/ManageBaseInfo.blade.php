                    ...
                    <input type="text" value="{{ $tmpCounter = 1; }}" hidden>
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            ...
                            <div class="collapse" id="collapseUnitItems" style="padding:.75rem;">
                                <div class="alert alert-success alert-dismissible" role="alert" id="UnitSuccessAlert" hidden>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <p style="text-align:right;" id="UnitSuccessMessage"></p>
                                </div>
                                <div class="alert alert-warning alert-dismissible" role="alert" id="UnitWarningAlert" hidden>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                ...
                                <form class="user" id="UnitsForm" enctype="application/x-www-form-urlencoded">
                                    <div class="form-group row">
                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                            ...
                                            <input type="text" class="form-control form-control-user" id="UnitTitle" name="Title"
                                                   placeholder="عنوان یگان">
                                        </div>
                                        <div class="col-sm-2">
                                            <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddUnit">
                                                ایجاد یگان
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive" dir="ltr" id="UnitTableWrapper">
                                    <table class="table table-bordered" id="UnitdataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>ردیف</th>
                                                <th>عنوان یگان</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseUnitGroupsItems" class="d-block card-header py-3 collapsed" data-toggle="collapse"
                               role="button" aria-expanded="false" aria-controls="collapseUnitGroupsItems">
                            ...
                            <div class="collapse" style="padding:.75rem;" id="collapseUnitGroupsItems">
                                <div class="alert alert-success alert-dismissible" role="alert" id="UnitGroupSuccessAlert" hidden>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <p style="text-align:right;" id="UnitGroupSuccessMessage"></p>
                                </div>
                                <div class="alert alert-warning alert-dismissible" role="alert" id="UnitGroupWarningAlert" hidden>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    <p style="text-align:right;" id="UnitGroupWarningMessage"></p>
                                </div>
                                <div class="alert alert-danger alert-dismissible" role="alert" id="UnitGroupErrorAlert" hidden>
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                ...
                                <form class="user" id="UnitGroupsForm">
                                    <div class="form-group row">
                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                            ...
                                            <select class="form-control allWidth" data-ng-style="btn-primary" id="UnitGroupsUnitId" name="UnitId" style="padding:0 .75rem;">
                                        ...
                                        <div class="col-sm-4 mb-3 mb-sm-0">
                                            <input type="text" class="form-control form-control-user" id="GroupTitle" name="GroupTitle"
                                                   placeholder="عنوان گروه">
                                        </div>
                                        <div class="col-sm-2">
                                            <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddGroup">
                                                ایجاد گروه
                                            </button>
                                        </div>
                                    </div>
                                ...
                                <div class="table-responsive" dir="ltr" id="UnitGroupTableWrapper">
                                    <table class="table table-bordered" id="UnitGroupdataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                        <thead>
                                            <tr>
                                                <th>ردیف</th>
                                                <th>یگان</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            ...
                            <div class="collapse" style="padding:.75rem;" id="collapseGradesItems">
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" role="alert" id="GradeSuccessAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="GradeSuccessMessage"></p>
                                    </div>
                                    <div class="alert alert-warning alert-dismissible" role="alert" id="GradeWarningAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="GradeWarningMessage"></p>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" role="alert" id="GradeErrorAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <form class="user" id="GradesForm">
                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                ...
                                                <input type="text" value="" id="GradeSettingValue" name="SettingValue" hidden />
                                                <input type="text" value="GradeId" id="GradeSettingKey" name="SettingKey" hidden />
                                                <input type="checkbox" value="false" id="GradeIsDeleted" name="IsDeleted" hidden />
                                                <input type="text" class="form-control form-control-user" id="GradeSettingTitle" name="SettingTitle"
                                                       placeholder="عنوان مقطع تحصیلی">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddGrade">
                                                    ایجاد مقطع تحصیلی
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" dir="ltr" id="GradeTableWrapper">
                                        <table class="table table-bordered" id="GradedataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ردیف</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            ...
                            <div class="collapse" style="padding:.75rem;" id="collapseMajorsItems">
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" role="alert" id="MajorSuccessAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="MajorSuccessMessage"></p>
                                    </div>
                                    <div class="alert alert-warning alert-dismissible" role="alert" id="MajorWarningAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="MajorWarningMessage"></p>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" role="alert" id="MajorErrorAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <form class="user" id="MajorsForm">
                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                ...
                                                <input type="text" class="form-control form-control-user" id="MajorTitle" name="Title"
                                                       placeholder="عنوان رشته تحصیلی">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddMajor">
                                                    ایجاد رشته تحصیلی
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" dir="ltr" id="MajorTableWrapper">
                                        <table class="table table-bordered" id="MajordataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ردیف</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseOreintationsItems" class="d-block card-header py-3 collapsed" data-toggle="collapse"
                               role="button" aria-expanded="false" aria-controls="collapseOreintationsItems">
                                <h6 class="m-0 font-weight-bold text-primary">گرایش</h6>
                            </a>
                            <!-- Card Content - Collapse -->
                            <div class="collapse" style="padding:.75rem;" id="collapseOreintationsItems">
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" role="alert" id="OreintationSuccessAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="OreintationSuccessMessage"></p>
                                    </div>
                                    <div class="alert alert-warning alert-dismissible" role="alert" id="OreintationWarningAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="OreintationWarningMessage"></p>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" role="alert" id="OreintationErrorAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <form class="user" id="OreintationsForm">
                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <input type="text" value="" id="NidOreintation" name="NidOreintation" hidden />
                                                <select class="form-control allWidth" data-ng-style="btn-primary" name="MajorId" id="OreintationMajorId" style="padding:0 .75rem;">
                                                    <option value="0" disabled selected>انتخاب رشته تحصیلی</option>
                                                    @foreach ($Majors as $ore)
                                                    <option value="{{ $ore->NidMajor }}">{{ $ore->Title }}</option>
                                                    @endforeach
                                                </select>
                                            </div>
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <input type="text" class="form-control form-control-user" id="OreintationTitle" name="Title"
                                                       placeholder="عنوان گرایش">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddOreintation">
                                                    ایجاد گرایش
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" dir="ltr" id="OreintationTableWrapper">
                                        <table class="table table-bordered" id="OreintationdataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ردیف</th>
                                                    <th>رشته تحصیلی</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseCollegesItems" class="d-block card-header py-3 collapsed" data-toggle="collapse"
                               role="button" aria-expanded="false" aria-controls="collapseCollegesItems">
                                <h6 class="m-0 font-weight-bold text-primary">محل تحصیل</h6>
                            </a>
                            <!-- Card Content - Collapse -->
                            <div class="collapse" style="padding:.75rem;" id="collapseCollegesItems">
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" role="alert" id="CollegeSuccessAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="CollegeSuccessMessage"></p>
                                    </div>
                                    <div class="alert alert-warning alert-dismissible" role="alert" id="CollegeWarningAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="CollegeWarningMessage"></p>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" role="alert" id="CollegeErrorAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <form class="user" id="CollegesForm">
                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <input type="text" value="" id="CollegeNidSetting" name="NidSetting" hidden />
                                                <input type="text" value="" id="CollegeSettingValue" name="SettingValue" hidden />
                                                <input type="text" value="College" id="CollegeSettingKey" name="SettingKey" hidden />
                                                <input type="checkbox" value="false" id="CollegeIsDeleted" name="IsDeleted" hidden />
                                                <input type="text" class="form-control form-control-user" id="CollegeSettingTitle" name="SettingTitle"
                                                       placeholder="عنوان دانشکده">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddCollege">
                                                    ایجاد دانشکده
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" dir="ltr" id="CollegeTableWrapper">
                                        <table class="table table-bordered" id="CollegedataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ردیف</th>
                                                    <th>عنوان دانشکده</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseMillitaryStatusesItems" class="d-block card-header py-3 collapsed" data-toggle="collapse"
                               role="button" aria-expanded="false" aria-controls="collapseMillitaryStatusesItems">
                            ...
                            <div class="collapse" style="padding:.75rem;" id="collapseMillitaryStatusesItems">
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" role="alert" id="MillitSuccessAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="MillitSuccessMessage"></p>
                                    </div>
                                    <div class="alert alert-warning alert-dismissible" role="alert" id="MillitWarningAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="MillitWarningMessage"></p>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" role="alert" id="MillitErrorAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <form class="user" id="MillitsForm">
                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <input type="text" value="" id="MillitNidSetting" name="NidSetting" hidden />
                                                <input type="text" value="" id="MillitSettingValue" name="SettingValue" hidden />
                                                <input type="text" value="MillitaryStatus" id="MillitSettingKey" name="SettingKey" hidden />
                                                <input type="checkbox" value="false" id="MillitIsDeleted" name="IsDeleted" hidden />
                                                <input type="text" class="form-control form-control-user" id="MillitSettingTitle" name="SettingTitle"
                                                       placeholder="عنوان وضعیت خدمتی">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddMillit">
                                                    ایجاد وضعیت خدمتی
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" dir="ltr" id="MillitTableWrapper">
                                        <table class="table table-bordered" id="MillitdataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ردیف</th>
                        ...
                        <div class="card shadow" style="text-align:right;margin-bottom:1rem;">
                            <!-- Card Header - Accordion -->
                            <a href="#collapseCollaborationTypesItems" class="d-block card-header py-3 collapsed" data-toggle="collapse"
                               role="button" aria-expanded="false" aria-controls="collapseCollaborationTypesItems">
                            ...
                            <div class="collapse" style="padding:.75rem;" id="collapseCollaborationTypesItems">
                                <div class="card-body">
                                    <div class="alert alert-success alert-dismissible" role="alert" id="CollabSuccessAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="CollabSuccessMessage"></p>
                                    </div>
                                    <div class="alert alert-warning alert-dismissible" role="alert" id="CollabWarningAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        <p style="text-align:right;" id="CollabWarningMessage"></p>
                                    </div>
                                    <div class="alert alert-danger alert-dismissible" role="alert" id="CollabErrorAlert" hidden>
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    ...
                                    <form class="user" id="CollabsForm">
                                        <div class="form-group row">
                                            <div class="col-sm-4 mb-3 mb-sm-0">
                                                <input type="text" value="" id="CollabNidSetting" name="NidSetting" hidden />
                                                <input type="text" value="" id="CollabSettingValue" name="SettingValue" hidden />
                                                <input type="text" value="CollaborationType" id="CollabSettingKey" name="SettingKey" hidden />
                                                <input type="checkbox" value="false" id="CollabIsDeleted" name="IsDeleted" hidden />
                                                <input type="text" class="form-control form-control-user" id="CollabSettingTitle" name="SettingTitle"
                                                       placeholder="عنوان نوع همکاری">
                                            </div>
                                            <div class="col-sm-2">
                                                <button class="btn btn-primary btn-user btn-block" type="submit" id="btnAddCollab">
                                                    ایجاد نوع همکاری
                                                </button>
                                            </div>
                                        </div>
                                    ...
                                    <div class="table-responsive" dir="ltr" id="CollabTableWrapper">
                                        <table class="table table-bordered" id="CollabdataTable" style="width:100%;direction:rtl;text-align:center;" cellspacing="0">
                                            <thead>
                                                <tr>
                                                    <th>ردیف</th>
                        ...
                        <hr>
                        <a href="{{ URL('project.Projects') }} id="btnSubmit" class="btn btn-outline-secondary btn-user btn-block" style="width:25%;margin:auto;">
...
@section ('scripts')
    <script type="text/javascript">
        $(function ()
        {
            ...
            {
                e.preventDefault();
                var model = { NidUnit: $("#NidUnit").val(), Title: $("#UnitTitle").val() };
                $.ajax(
                    {
                        url: '@Url.Action("SubmitUnitForm","Home")',
                        type: 'post',
                        datatype: 'json',
                        ...
                        success: function (result)
                        {
                            if(result.HasValue)
                            {
                                ...
                                $("#UnitsForm").each(function () { this.reset(); });
                                $("#UnitSuccessMessage").text(result.Message);
                                $("#UnitSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#UnitSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                $("#UnitGroupsUnitId").append(new Option(model.Title, result.AltProp));
                            } else {
                                $("#UnitErrorMessage").text(result.Message);
                                $("#UnitErrorAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#UnitErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function ()
                        {
            ...
            $("#btnAddGroup").click(function (e) {
                e.preventDefault();
                var model = { NidGroup: $("#NidGroup").val(), Title: $("#GroupTitle").val(), UnitId: $("#UnitGroupsUnitId").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#UnitGroupsForm").each(function () { this.reset(); });
                                $("#UnitGroupSuccessMessage").text(result.Message);
                                $("#UnitGroupSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#UnitGroupSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                window.setTimeout(function () { $("#UnitGroupErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
            ...
            $("#btnAddGrade").click(function (e) {
                e.preventDefault();
                var model = { NidSetting: $("#GradeNidSetting").val(), SettingValue: $("#GradeSettingValue").val(), SettingKey: $("#GradeSettingKey").val(), SettingTitle: $("#GradeSettingTitle").val(), IsDeleted: $("#GradeIsDeleted").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#GradesForm").each(function () { this.reset(); });
                                $("#GradeSuccessMessage").text(result.Message);
                                $("#GradeSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#GradeSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                window.setTimeout(function () { $("#GradeErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
            ...
            $("#btnAddMajor").click(function (e) {
                e.preventDefault();
                var model = { NidMajor: $("#NidMajor").val(), Title: $("#MajorTitle").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#MajorsForm").each(function () { this.reset(); });
                                $("#MajorSuccessMessage").text(result.Message);
                                $("#MajorSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#MajorSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                $("#OreintationMajorId").append(new Option(model.Title, result.AltProp));
                            } else {
                                $("#MajorErrorMessage").text(result.Message);
                                $("#MajorErrorAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#MajorErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
                            $("#UnitErrorMessage").text('خطا در سرور.لطفا مجددا امتحان کنید');
            ...
            $("#btnAddOreintation").click(function (e) {
                e.preventDefault();
                var model = { NidOreintation: $("#NidOreintation").val(), Title: $("#OreintationTitle").val(), MajorId: $("#OreintationMajorId").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#OreintationsForm").each(function () { this.reset(); });
                                $("#OreintationSuccessMessage").text(result.Message);
                                $("#OreintationSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#OreintationSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                window.setTimeout(function () { $("#OreintationErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
            ...
            $("#btnAddCollege").click(function (e) {
                e.preventDefault();
                var model = { NidSetting: $("#CollegeNidSetting").val(), SettingValue: $("#CollegeSettingValue").val(), SettingKey: $("#CollegeSettingKey").val(), SettingTitle: $("#CollegeSettingTitle").val(), IsDeleted: $("#CollegeIsDeleted").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#CollegesForm").each(function () { this.reset(); });
                                $("#CollegeSuccessMessage").text(result.Message);
                                $("#CollegeSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#CollegeSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                window.setTimeout(function () { $("#CollegeErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
            ...
            $("#btnAddMillit").click(function (e) {
                e.preventDefault();
                var model = { NidSetting: $("#MillitNidSetting").val(), SettingValue: $("#MillitSettingValue").val(), SettingKey: $("#MillitSettingKey").val(), SettingTitle: $("#MillitSettingTitle").val(), IsDeleted: $("#MillitIsDeleted").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#MillitsForm").each(function () { this.reset(); });
                                $("#MillitSuccessMessage").text(result.Message);
                                $("#MillitSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#MillitSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                window.setTimeout(function () { $("#MillitErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
            ...
            $("#btnAddCollab").click(function (e) {
                e.preventDefault();
                var model = { NidSetting: $("#CollabNidSetting").val(), SettingValue: $("#CollabSettingValue").val(), SettingKey: $("#CollabSettingKey").val(), SettingTitle: $("#CollabSettingTitle").val(), IsDeleted: $("#CollabIsDeleted").val() };
                $.ajax(
                    {
                        ...
                        success: function (result) {
                            if (result.HasValue) {
                                ...
                                $("#CollabsForm").each(function () { this.reset(); });
                                $("#CollabSuccessMessage").text(result.Message);
                                $("#CollabSuccessAlert").removeAttr('hidden');
                                window.setTimeout(function () { $("#CollabSuccessAlert").attr('hidden','hidden'); }, 3000);
                                ...
                                window.setTimeout(function () { $("#CollabErrorAlert").attr('hidden','hidden'); }, 3000);
                            }
                        },
                        error: function () {
            ...
            switch (CurrentDeleteTypo) {
                ...
                case 2:
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidUnitGroup: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#UnitGroupTableWrapper").html(result.Html);
                                $("#UnitGroupSuccessMessage").text(result.Message);
                ...
                case 3:
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidGrade: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#GradeTableWrapper").html(result.Html);
                                $("#GradeSuccessMessage").text(result.Message);
                ...
                case 4:
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidMajor: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#MajorTableWrapper").html(result.Html);
                                $("#MajorSuccessMessage").text(result.Message);
                ...
                case 5:
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidOreintation: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#OreintationTableWrapper").html(result.Html);
                                $("#OreintationSuccessMessage").text(result.Message);
                ...
                case 6:
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidCollege: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#CollegeTableWrapper").html(result.Html);
                                $("#CollegeSuccessMessage").text(result.Message);
                    ...
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidMillit: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#MillitTableWrapper").html(result.Html);
                                $("#MillitSuccessMessage").text(result.Message);
                ...
                case 8:
                    $.ajax({
                        ...
                        type: 'post',
                        datatype: 'json',
                        data: { NidCollab: CurrentDeleteNid },
                        success: function (result) {
                            if (result.HasValue) {
                                $("#CollabTableWrapper").html(result.Html);
                                $("#CollabSuccessMessage").text(result.Message);
